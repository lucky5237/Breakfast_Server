...
from app import api
from API.User import Login, Register, CheckMobile, ChangePwd, AveScore, UserInfo
from API.Order import MakeOrder, OrderList, Comment, TakeOrder, UpdateStatus
...
api.add_resource(OrderList, '/order/orderList')
